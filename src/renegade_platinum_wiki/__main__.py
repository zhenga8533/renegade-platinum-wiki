"""
Main entry point for renegade-platinum-wiki.
"""
...
def main():
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Examples:
  python -m renegade_platinum_wiki --init                        # Initialize PokeDB data
  python -m renegade_platinum_wiki --parsers all                 # Run all parsers
  python -m renegade_platinum_wiki --parsers pokemon_changes     # Run specific parser
  python -m renegade_platinum_wiki --generators all              # Run all generators
  python -m renegade_platinum_wiki --generators pokemon          # Run specific generator
  python -m renegade_platinum_wiki --init --parsers all          # Initialize and run all parsers
        """,
    )
