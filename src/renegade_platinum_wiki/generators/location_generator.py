...
from renegade_platinum_wiki.generators.base_generator import BaseGenerator
from renegade_platinum_wiki.utils.core.config import GENERATOR_DEX_RELATIVE_PATH
...
from renegade_platinum_wiki.utils.formatters.yaml_formatter import update_mkdocs_nav
...
class LocationGenerator(BaseGenerator):
    ...
    def generate_index(
        ...
        """
        from renegade_platinum_wiki.utils.core.config import GAME_TITLE
        from renegade_platinum_wiki.utils.formatters.table_formatter import create_table
    ...
    def _build_location_markdown(self, location_data: Dict[str, Any]) -> str:
        ...
        has_main_content = location_data.get("trainers") or location_data.get(
            "wild_encounters"
        )
    ...
    def _build_sublocations_section(
        ...
        for sublocation_name, sublocation_data in sublocations.items():
            ...
            has_content = sublocation_data.get("trainers") or sublocation_data.get(
                "wild_encounters"
            )
