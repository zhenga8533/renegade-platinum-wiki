...
class WildPokemonParser(LocationParser):
    ...
    def parse_area_changes(self, line: str) -> None:
        ...
        if next_line.startswith("Levels:"):
            ...
            if " ~ " in location_raw:
                ...
                self._ensure_sublocation_exists(self._current_location, self._current_sublocation)
                ...
                self._clear_location_data_on_first_encounter("wild_encounters", "wild_encounters", sublocation_key)
    ...
    def _add_wild_encounters_to_location(self, method: str, encounters: list[Dict[str, Any]], level_range: str) -> None:
