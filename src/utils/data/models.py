...
To change the target generation, edit src/utils/core/config.py:
  - POKEDB_VERSION_GROUPS: List of version group keys (e.g., ["platinum", "diamond_pearl", "heartgold_soulsilver"])
  - POKEDB_GAME_VERSIONS: List of individual game version keys (e.g., ["platinum", "diamond", "pearl", "heartgold", "soulsilver"])
  - POKEDB_SPRITE_VERSION: The sprite version key to use (e.g., "platinum")
...
class GameVersionStringMap(_GameVersionMap[str]):
    ...
    platinum: Optional[str]
    diamond_pearl: Optional[str]
    heartgold_soulsilver: Optional[str]
...
class GameVersionIntMap(_GameVersionMap[int]):
    ...
    # Pre-declare attributes for static analysis (mypy/linter)
    # <-- EDIT HERE when switching generations
    platinum: Optional[int]
    diamond_pearl: Optional[int]
    heartgold_soulsilver: Optional[int]
...
class GameStringMap(_GameVersionMap[str]):
    ...
    # <-- EDIT HERE when switching generations
    platinum: Optional[str]
    diamond: Optional[str]
    pearl: Optional[str]
    heartgold: Optional[str]
    soulsilver: Optional[str]
