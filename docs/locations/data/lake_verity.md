...
| Pokémon | Type(s) | Level(s) | Chance |
|:-------:|:-------:|:---------|:-------|
| ![wynaut](https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/versions/generation-iv/heartgold-soulsilver/360.png){ .sprite }<br>[Wynaut](../../pokedex/pokemon/wynaut.md) | <div class='badges-vstack'><span class="type-badge" style="background: linear-gradient(135deg, #F85888 0%, #F85888dd 100%);">Psychic</span></div> | 4 - 5 | 22% |
