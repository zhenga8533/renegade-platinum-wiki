...
| <span class="tooltip" title="The foe is stabbed with a horn rotating like a drill. The foe instantly faints if it hits.">Horn Drill</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | — | 30 | 5 |
