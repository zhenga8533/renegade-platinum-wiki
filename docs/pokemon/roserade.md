...
|------------|---------|--------|--------|-----------|---------|
| #407 | ![grass](../assets/types/grass.png "Grass"){: width="48"} ![poison](../assets/types/poison.png "Poison"){: width="48"} | 0.9 m /<br>3.0 ft | 14.5 kg /<br>32.0 lbs | 1. <span class="tooltip" title="Powers up the Pokémon’s weaker moves.">Technician</span><br>2. <span class="tooltip" title="All status problems are healed upon switching out.">Natural Cure</span> | #27 |
