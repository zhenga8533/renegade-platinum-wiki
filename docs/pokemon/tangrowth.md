...
| --- | --- |
| ![Official Artwork](../assets/sprites/tangrowth/official.png) | ![Shiny Artwork](../assets/sprites/tangrowth/official_shiny.png) |
...
|------------|---------|--------|--------|-----------|---------|
| #465 | ![grass](../assets/types/grass.png){: width='48'} | 2.0 m | 128.6 kg | 1. Chlorophyll<br>2. Leaf-Guard<br>3. Regenerator | N/A |
