...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/hypno/official.png "Hypno") | ![Shiny Artwork](../assets/sprites/hypno/official_shiny.png "Hypno") |
...
|------------|------------|--------|-----------|-------|-------|
| 1. Humanshape | 20 | 50.0% Male<br>50.0% Female | True | Yellow | Humanoid |
...
| 1 | <span class="tooltip" title="A sleeping foe is shown a nightmare that inflicts some damage every turn. ">Nightmare</span> | ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 15 |
