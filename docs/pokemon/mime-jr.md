...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/mime-jr/official.png "Mime Jr") | ![Shiny Artwork](../assets/sprites/mime-jr/official_shiny.png "Mime Jr") |
...
|------------|------------|--------|-----------|-------|-------|
| 1. No-Eggs | 25 | 50.0% Male<br>50.0% Female | False | Pink | Humanoid |
...
| 1 | <span class="tooltip" title="The user tickles the foe into laughing, reducing its Attack and Defense stats. ">Tickle</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 20 |
...
| <span class="tooltip" title="The user faints. In return, the Pokémon taking its place will have its HP restored and status cured.">Healing Wish</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
