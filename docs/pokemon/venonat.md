...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/venonat/official.png "Venonat") | ![Shiny Artwork](../assets/sprites/venonat/official_shiny.png "Venonat") |
...
|------------|------------|--------|-----------|-------|-------|
| 1. Bug | 20 | 50.0% Male<br>50.0% Female | False | Purple | Humanoid |
...
| 33 | <span class="tooltip" title="The user switches places with a party Pokémon in waiting, passing along any stat changes.">Baton Pass</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 40 |
...
| 39 | <span class="tooltip" title="The user restores its own HP. The amount of HP regained varies with the weather.">Morning Sun</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
