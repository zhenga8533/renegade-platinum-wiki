...
|------------|---------|--------|--------|-----------|---------|
| #397 | ![normal](../assets/types/normal.png "Normal"){: width="48"}<br>![flying](../assets/types/flying.png "Flying"){: width="48"} | 0.6 m /<br>2.0 ft | 15.5 kg /<br>34.2 lbs | 1. <span class="tooltip" title="Powers up moves that have recoil damage.">Reckless</span><br>2. <span class="tooltip" title="Lowers the foe’s Attack stat.">Intimidate</span> | #11 |
