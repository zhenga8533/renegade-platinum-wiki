...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/kricketune/official.png "Kricketune") | ![Shiny Artwork](../assets/sprites/kricketune/official_shiny.png "Kricketune") |
...
|------------|---------|--------|--------|-----------|---------|
| #402 | ![bug](../assets/types/bug.png "Bug"){: width="48"} | 1.0 m /<br>3.3 ft | 25.5 kg /<br>56.2 lbs | 1. <span class="tooltip" title="Powers up the Pokémon’s weaker moves.">Technician</span><br>2. <span class="tooltip" title="Powers up Bug-type moves in a pinch.">Swarm</span> | #16 |
...
|----------|------------|-----------------|-----------|-------------|------------|
| 2 Attack | 45 | 70 | 134 | Medium Slow | <span class="tooltip" title="A Pokémon hold item that boosts a move used consecutively. Its effect is reset if another move is used.">Metronome</span> (5%) |
...
|------------|------------|--------|-----------|-------|-------|
| 1. Bug | 15 | 50.0% Male<br>50.0% Female | True | Red | Bug-Wings |
...
| 1 | <span class="tooltip" title="Any Pokémon that hears this song faints in three turns unless it switches out of battle.">Perish Song</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
...
| 13 | <span class="tooltip" title="A nutrient-draining attack. The user’s HP is restored by half the damage taken by the target.">Absorb</span> | ![grass](../assets/types/grass.png "Grass"){: width="48"} | ![special](../assets/move_category/special.png "Special"){: width="36"} | 20 | 100 | 25 |
| 16 | <span class="tooltip" title="A soothing lullaby is sung in a calming voice that puts the foe into a deep slumber.">Sing</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 55 | 15 |
| 19 | <span class="tooltip" title="A blood-draining attack. The user’s HP is restored by half the damage taken by the target.">Leech Life</span> | ![bug](../assets/types/bug.png "Bug"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 80 | 100 | 10 |
| 22 | <span class="tooltip" title="The user takes a deep breath and focuses to raise the critical-hit ratio of its attacks.">Focus Energy</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 30 |
...
| 25 | <span class="tooltip" title="The foe is attacked with a slash of claws, etc. It has a high critical-hit ratio.">Slash</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 20 |
...
| 49 | <span class="tooltip" title="Any Pokémon that hears this song faints in three turns unless it switches out of battle.">Perish Song</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 5 |
