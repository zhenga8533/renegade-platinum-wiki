...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/rotom-mow/official.png "Rotom Mow") | ![Shiny Artwork](../assets/sprites/rotom-mow/official_shiny.png "Rotom Mow") |
...
<audio controls>
<source src='../../assets/cries/rotom-mow/latest.ogg' type='audio/ogg'>
...
<audio controls>
<source src='../../assets/cries/rotom-mow/legacy.ogg' type='audio/ogg'>
  Your browser does not support the audio element.
</audio>
...
|------------|---------|--------|--------|-----------|---------|
| #10012 | ![electric](../assets/types/electric.png "Electric"){: width="48"}<br>![grass](../assets/types/grass.png "Grass"){: width="48"} | 0.3 m /<br>1.0 ft | 0.3 kg /<br>0.7 lbs | 1. <span class="tooltip" title="Raises Speed if hit by an Electric-type move.">Motor Drive</span> | N/A |
...
Rotom Mow cannot learn any moves by breeding.
### Tutor Moves
