...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/abra/official.png "Abra") | ![Shiny Artwork](../assets/sprites/abra/official_shiny.png "Abra") |
...
|------------|---------|--------|--------|-----------|---------|
| #63 | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | 0.9 m /<br>3.0 ft | 19.5 kg /<br>43.0 lbs | 1. <span class="tooltip" title="The Pokémon only takes damage from attacks.">Magic Guard</span><br>2. <span class="tooltip" title="Passes on a burn, poison, or paralysis to the foe.">Synchronize</span> | #20 |
...
|------------|------------|--------|-----------|-------|-------|
| 1. Humanshape | 20 | 75.0% Male<br>25.0% Female | False | Brown | Upright |
...
| <span class="tooltip" title="The user employs its psychic power to switch its Attack with its Defense stat.">Power Trick</span> | ![psychic](../assets/types/psychic.png "Psychic"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
