...
| --- | --- |
| ![Official Artwork](../assets/sprites/koffing/official.png) | ![Shiny Artwork](../assets/sprites/koffing/official_shiny.png) |
...
|------------|---------|--------|--------|-----------|---------|
| #109 | ![poison](../assets/types/poison.png){: width='48'} | 0.6 m | 1.0 kg | 1. Levitate<br>2. Neutralizing-Gas<br>3. Stench | N/A |
