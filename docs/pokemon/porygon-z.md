...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/porygon-z/official.png "Porygon Z") | ![Shiny Artwork](../assets/sprites/porygon-z/official_shiny.png "Porygon Z") |
...
| 22 | <span class="tooltip" title="It prevents the foe from using its held item. Its Trainer is also prevented from using items on it.">Embargo</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 15 |
