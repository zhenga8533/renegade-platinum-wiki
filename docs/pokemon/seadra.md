...
| --- | --- |
| ![Official Artwork](../assets/sprites/seadra/official.png) | ![Shiny Artwork](../assets/sprites/seadra/official_shiny.png) |
...
|------------|---------|--------|--------|-----------|---------|
| #117 | ![water](../assets/types/water.png){: width='48'} | 1.2 m | 25.0 kg | 1. Poison-Point<br>2. Sniper<br>3. Damp | N/A |
