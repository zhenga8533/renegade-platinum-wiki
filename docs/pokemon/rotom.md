...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/rotom/official.png "Rotom") | ![Shiny Artwork](../assets/sprites/rotom/official_shiny.png "Rotom") |
...
|------------|---------|--------|--------|-----------|---------|
| #479 | ![electric](../assets/types/electric.png "Electric"){: width="48"}<br>![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | 0.3 m /<br>1.0 ft | 0.3 kg /<br>0.7 lbs | 1. <span class="tooltip" title="Raises Speed if hit by an Electric-type move.">Motor Drive</span> | N/A |
