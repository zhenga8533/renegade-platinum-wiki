...
|------------|---------|--------|--------|-----------|---------|
| #479 | ![electric](../assets/types/electric.png "Electric"){: width="48"} ![ghost](../assets/types/ghost.png "Ghost"){: width="48"} | 0.3 m /<br>1.0 ft | 0.3 kg /<br>0.7 lbs | 1. <span class="tooltip" title="Raises Speed if hit by an Electric-type move.">Motor Drive</span> | N/A |
