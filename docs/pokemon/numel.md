...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/numel/official.png "Numel") | ![Shiny Artwork](../assets/sprites/numel/official_shiny.png "Numel") |
...
|------------|---------|--------|--------|-----------|---------|
| #322 | ![fire](../assets/types/fire.png "Fire"){: width="48"} ![ground](../assets/types/ground.png "Ground"){: width="48"} | 0.7 m /<br>2.3 ft | 24.0 kg /<br>52.9 lbs | 1. <span class="tooltip" title="The Pokémon is prone to wild stat changes.">Simple</span><br>2. <span class="tooltip" title="Prevents the Pokémon from becoming infatuated.">Oblivious</span> | N/A |
...
| 37 | <span class="tooltip" title="The user lets loose a huge yawn that lulls the foe into falling asleep on the next turn.">Yawn</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
