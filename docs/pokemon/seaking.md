...
| --- | --- |
| ![Official Artwork](../assets/sprites/seaking/official.png) | ![Shiny Artwork](../assets/sprites/seaking/official_shiny.png) |
...
|------------|---------|--------|--------|-----------|---------|
| #119 | ![water](../assets/types/water.png){: width='48'} | 1.3 m | 39.0 kg | 1. Swift-Swim<br>2. Water-Veil<br>3. Lightning-Rod | #79 |
...
| 47 | Megahorn | ![bug](../assets/types/bug.png){: width='48'} | ![physical](../assets/move_category/physical.png){: width='36'} | 120 | 85 | 10 |
