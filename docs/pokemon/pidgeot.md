...
| --- | --- |
| ![Official Artwork](../assets/sprites/pidgeot/official.png) | ![Shiny Artwork](../assets/sprites/pidgeot/official_shiny.png) |
...
|------------|---------|--------|--------|-----------|---------|
| #18 | ![normal](../assets/types/normal.png){: width='48'} ![flying](../assets/types/flying.png){: width='48'} | 1.5 m | 39.5 kg | 1. No-Guard<br>2. Tangled-Feet | N/A |
