...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/snorunt/official.png "Snorunt") | ![Shiny Artwork](../assets/sprites/snorunt/official_shiny.png "Snorunt") |
...
|------------|------------|--------|-----------|-------|-------|
| 1. Fairy<br>2. Mineral | 20 | 50.0% Male<br>50.0% Female | False | Gray | Humanoid |
...
| 36 | <span class="tooltip" title="It enables the user to evade all attacks. Its chance of failing rises if it is used in succession.">Protect</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 10 |
| 39 | <span class="tooltip" title="The user trades held items with the foe faster than the eye can follow. ">Switcheroo</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 100 | 10 |
