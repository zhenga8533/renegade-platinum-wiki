...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/honchkrow/official.png "Honchkrow") | ![Shiny Artwork](../assets/sprites/honchkrow/official_shiny.png "Honchkrow") |
...
| 29 | <span class="tooltip" title="The user enrages the foe into confusion. However, it also sharply raises the foe’s Attack stat.">Swagger</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | 85 | 15 |
