...
|------------|---------|--------|--------|-----------|---------|
| #167 | ![bug](../assets/types/bug.png "Bug"){: width="48"} ![poison](../assets/types/poison.png "Poison"){: width="48"} | 0.5 m /<br>1.6 ft | 8.5 kg /<br>18.7 lbs | 1. <span class="tooltip" title="Powers up Bug-type moves in a pinch.">Swarm</span><br>2. <span class="tooltip" title="Prevents the Pokémon from falling asleep.">Insomnia</span><br>3. <span class="tooltip" title="Powers up moves if they become critical hits.">Sniper</span> | N/A |
