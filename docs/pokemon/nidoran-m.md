...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/nidoran-m/official.png "Nidoran M") | ![Shiny Artwork](../assets/sprites/nidoran-m/official_shiny.png "Nidoran M") |
...
| 30 | <span class="tooltip" title="This move enables the user to attack first. It fails if the foe is not readying an attack, however.">Sucker Punch</span> | ![dark](../assets/types/dark.png "Dark"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 70 | 100 | 5 |
...
| 39 | <span class="tooltip" title="The user delivers a life-endangering head butt at full power. The user also takes terrible damage.">Head Smash</span> | ![rock](../assets/types/rock.png "Rock"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 150 | 80 | 5 |
