...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/sandslash/official.png "Sandslash") | ![Shiny Artwork](../assets/sprites/sandslash/official_shiny.png "Sandslash") |
...
| 45 | <span class="tooltip" title="A frenetic dance to uplift the fighting spirit. It sharply raises the user’s Attack stat.">Swords Dance</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![status](../assets/move_category/status.png "Status"){: width="36"} | — | — | 20 |
