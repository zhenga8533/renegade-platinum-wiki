...
|------------------|---------------|
| ![Official Artwork](../assets/sprites/nidoking/official.png "Nidoking") | ![Shiny Artwork](../assets/sprites/nidoking/official_shiny.png "Nidoking") |
...
|------------|------------|--------|-----------|-------|-------|
| 1. Monster<br>2. Ground | 20 | 100.0% Male<br>0.0% Female | False | Purple | Upright |
...
| 25 | <span class="tooltip" title="The user rampages and attacks for two to three turns. It then becomes confused, however.">Thrash</span> | ![normal](../assets/types/normal.png "Normal"){: width="48"} | ![physical](../assets/move_category/physical.png "Physical"){: width="36"} | 120 | 100 | 10 |
