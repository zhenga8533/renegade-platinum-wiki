...
Complete list of all abilities in **Renegade Platinum**.

> Click on any of the Abilities to see its full description.

## Gen III

| Ability | Effect |
|:--------|:-------|
| [Air Lock](abilities/air-lock.md) | Negates all effects of weather, but does not prevent the weather itself. |
...
| [Clear Body](abilities/clear-body.md) | Prevents stats from being lowered by other Pokémon. |
| [Cloud Nine](abilities/cloud-nine.md) | Negates all effects of weather, but does not prevent the weather itself. |
| [Color Change](abilities/color-change.md) | Changes type to match when hit by a damaging move. |
| [Compound Eyes](abilities/compound-eyes.md) | Increases moves' accuracy to 1.3×. |
| [Cute Charm](abilities/cute-charm.md) | Has a 30% chance of infatuating attacking Pokémon on contact. |
| [Damp](abilities/damp.md) | Prevents self destruct, explosion, and aftermath from working while the Pokémon is in battle. |
| [Drizzle](abilities/drizzle.md) | Summons rain that lasts indefinitely upon entering battle. |
...
| [Forecast](abilities/forecast.md) | Changes castform's type and form to match the weather. |
| [Guts](abilities/guts.md) | Increases Attack to 1.5× with a major status ailment. |
| [Huge Power](abilities/huge-power.md) | Doubles Attack in battle. |
| [Hustle](abilities/hustle.md) | Strengthens physical moves to inflict 1.5× damage, but decreases their accuracy to 0.8×. |
| [Hyper Cutter](abilities/hyper-cutter.md) | Prevents Attack from being lowered by other Pokémon. |
| [Illuminate](abilities/illuminate.md) | Doubles the wild encounter rate. |
...
| [Lightning Rod](abilities/lightning-rod.md) | Redirects single-target electric moves to this Pokémon where possible. Absorbs Electric moves, raising Special Attack one stage. |
| [Limber](abilities/limber.md) | Prevents paralysis. |
| [Liquid Ooze](abilities/liquid-ooze.md) | Damages opponents using leeching moves for as much as they would heal. |
| [Magma Armor](abilities/magma-armor.md) | Prevents freezing. |
...
| [Minus](abilities/minus.md) | Increases Special Attack to 1.5× when a friendly Pokémon has plus or minus. |
| [Natural Cure](abilities/natural-cure.md) | Cures any major status ailment upon switching out. |
| [Oblivious](abilities/oblivious.md) | Prevents infatuation and protects against captivate. |
...
| [Pickup](abilities/pickup.md) | Picks up other Pokémon's used and Flung held items. May also pick up an item after battle. |
| [Plus](abilities/plus.md) | Increases Special Attack to 1.5× when a friendly Pokémon has plus or minus. |
| [Poison Point](abilities/poison-point.md) | Has a 30% chance of poisoning attacking Pokémon on contact. |
| [Pressure](abilities/pressure.md) | Increases the PP cost of moves targetting the Pokémon by one. |
| [Pure Power](abilities/pure-power.md) | Doubles Attack in battle. |
| [Rain Dish](abilities/rain-dish.md) | Heals for 1/16 max HP after each turn during rain. |
...
| [Run Away](abilities/run-away.md) | Ensures success fleeing from wild battles. |
...
| [Speed Boost](abilities/speed-boost.md) | Raises Speed one stage after each turn. |
| [Static](abilities/static.md) | Has a 30% chance of paralyzing attacking Pokémon on contact. |
| [Stench](abilities/stench.md) | Has a 10% chance of making target Pokémon flinch with each hit. |
| [Sticky Hold](abilities/sticky-hold.md) | Prevents a held item from being removed by other Pokémon. |
...
| [Truant](abilities/truant.md) | Skips every second turn. |
...
| [Water Veil](abilities/water-veil.md) | Prevents burns. |
| [White Smoke](abilities/white-smoke.md) | Prevents stats from being lowered by other Pokémon. |
| [Wonder Guard](abilities/wonder-guard.md) | Protects against damaging moves that are not super effective. |

## Gen IV

| Ability | Effect |
|:--------|:-------|
| [Adaptability](abilities/adaptability.md) | Increases the same-type attack bonus from 1.5× to 2×. |
| [Aftermath](abilities/aftermath.md) | Damages the attacker for 1/4 its max HP when knocked out by a contact move. |
| [Anger Point](abilities/anger-point.md) | Raises Attack to the maximum of six stages upon receiving a critical hit. |
...
| [Bad Dreams](abilities/bad-dreams.md) | Damages sleeping opponents for 1/8 their max HP after each turn. |
| [Download](abilities/download.md) | Raises the attack stat corresponding to the opponents' weaker defense one stage upon entering battle. |
...
| [Filter](abilities/filter.md) | Decreases damage taken from super-effective moves by 1/4. |
...
| [Heatproof](abilities/heatproof.md) | Halves damage from fire moves and burns. |
| [Honey Gather](abilities/honey-gather.md) | The Pokémon may pick up honey after battle. |
...
| [Klutz](abilities/klutz.md) | Prevents the Pokémon from using its held item in battle. |
| [Leaf Guard](abilities/leaf-guard.md) | Protects against major status ailments during strong sunlight. |
...
| [Motor Drive](abilities/motor-drive.md) | Absorbs electric moves, raising Speed one stage. |
| [Multitype](abilities/multitype.md) | Changes arceus's type and form to match its held Plate. |
| [No Guard](abilities/no-guard.md) | Ensures all moves used by and against the Pokémon hit. |
| [Normalize](abilities/normalize.md) | Makes the Pokémon's moves all act normal-type. |
| [Poison Heal](abilities/poison-heal.md) | Heals for 1/8 max HP after each turn when poisoned in place of damage. |
| [Quick Feet](abilities/quick-feet.md) | Increases Speed to 1.5× with a major status ailment. |
...
| [Slow Start](abilities/slow-start.md) | Halves Attack and Speed for five turns upon entering battle. |
...
| [Stall](abilities/stall.md) | Makes the Pokémon move last within its move's priority bracket. |
