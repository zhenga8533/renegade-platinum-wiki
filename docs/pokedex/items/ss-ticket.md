...
!!! info "Item"
	...
	<div style="display: flex; align-items: flex-start; gap: 15px;">
		...
		<div>
			...
			<br/>
			<span markdown>**Flavor Text:** The ticket required for sailing on the ferry S.S. Anne. It has a drawing of a ship on it.</span>
		</div>
	</div>
...
!!! tip "Quick Summary"
    ...
    Ticket for a ship. (RSE: S.S. Tidal LF: S.S. Anne HG: S.S. Aqua)
