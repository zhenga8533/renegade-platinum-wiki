...
## :material-pokeball: Key Features

<div class="grid cards" markdown>

-   __All 493 Pokémon Available__
...
-   __Quality of Life Improvements__
    ...
    [Details Below →](#quality-of-life-changes)

</div>

---

## :material-pokemon-go: All 493 Pokémon Available
...
## :material-account-group: Revamped Trainer Battles
...
## :material-sword-cross: Harder Boss Battles
...
!!! danger "Prepare for a Challenge"
...
## :material-star: Pokémon Modifications

### Typing and Stats

!!! success "Fairy-Type Added"
...
??? tip "Optional Pokémon Buffs (Click to expand)"
    ...
    !!! warning "Don't Like These Changes?"
...
## :material-wrench: Quality of Life Changes
...
!!! success "Effectively Infinite TMs"
...
??? tip "Alternative Shiny Rates Available"
...
### :material-speedometer: Increased Gameplay Speed

!!! warning "Optional Speed Up Patch"
...
1. **Instant text** - All text appears immediately
2. **No HP/EXP bar animations** - Bars jump to positions instantly
3. **60 FPS cap removed** - Game can run up to 60 FPS (depending on hardware)

These changes together mean battles can go **significantly faster**.

---

## :material-gift: New Events and NPCs

### Story Flow Changes

Some new events change the story flow slightly:

!!! example "Route 216 Early Access"
...
!!! success "Many Ways to Obtain Special Pokémon"
...
## :material-dna: Evolution Modifications

### Trade Evolutions Removed

!!! success "No More Trade Evolution Requirements"
...
## :material-karate: Move Modifications
...
## :material-bag-personal: Item Modifications

### Reshuffled Item Locations

!!! success "Better Item Access"
...
## :material-swap-horizontal: Trade Modifications

!!! tip "Better In-Game Trades"
...
!!! success "Obedience Check Disabled"
...
- **Online at:** [https://pastebin.com/u/RenegadePlatinum](https://pastebin.com/u/RenegadePlatinum)

---

## :material-bug: Known Bugs
...
!!! success "Download Renegade Platinum"

    **[Download from Google Drive](https://t.co/pljSVD0yyG)**
...
!!! warning "Patching Instructions"

    1. Obtain a Platinum ROM (you must provide this yourself)
    2. Use the correct patch for your ROM version (v1 or v1.1)
    3. Apply additional patches with Delta Patcher Lite
    4. **Important:** Uncheck "checksum validation" when applying more than two patches
...
If you wish to contact the original hack creator for any reason, the fastest way is to message **[@Drayano60 on Twitter](https://twitter.com/Drayano60)**.
